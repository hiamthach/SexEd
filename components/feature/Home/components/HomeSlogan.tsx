...
const HomeSlogan = () => {
  ...
  return (
    <div className="w-full py-[70px] flex gap-[82px] items-center">
      <div className="w-[40%]">
        <h3 className="font-heading text-[32px] leading-[36px] text-palette-2 ">Slogan laboris cupidatat consequat</h3>
      ...
      <div className="w-[60%] flex gap-[40px]">
        ...
        >
          ...
          <p className="text-[16px] font-[400]">Mollit ullamco laboris elit eiusmod aute adipisicing.</p>
        </div>
        <div
          className="rounded-[36px] bg-light p-[32px] w-[50%] hover:shadow-lg cursor-pointer"
          onClick={() => {
